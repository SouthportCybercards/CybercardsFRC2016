...
class Robot: public IterativeRobot
{
    ...
    Talon tapeDrive;
    Talon winchDrive;
    Joystick leftStick, rightStick, guitar;
    ...
    void RobotInit()
    {
        ...
        demoVar = prefs->GetFloat("Speed Multiplier",1.0);//1x speed by default REQUIRES RESTART
        isDemo = prefs->GetBoolean("Enable Demo?",0);//0 = false by default
    }
    /**
    ...
    */
	...
	void BallIntake(){
		bool intakeButton = guitar.GetRawButton(6);//changed, green button
		bool shootButton = guitar.GetRawButton(2);//changed, red button
